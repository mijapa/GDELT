...
\begin{document}
    ...
    W tableach od~\ref{tab:cl1stdcount} do~\ref{tab:cl9stdcount} została przedstawiona procentowa ilość państw w poszczególnych przedziałach w obrębie klastrów.
    W tableach od~\ref{tab:cl0std_desc} do~\ref{tab:cl9std_desc} pokazane zostały parametry poszególnych klastrów: średnia, mediana, odchylenie standardowe, minimum, maksimum.
