...
\begin{document}
    ...
    \begin{figure}[ht!]
        ...
        \caption{Mapa z PKP na osobę - skala logarytminczna. (źródło: opracowanie własne)}
    ...
    \input{./tables/CLUST/clust0stdkmeans.tex}

    \input{./tables/CLUST/desc/clust0std_desc.tex}

    \input{./tables/CLUST/clust1stdkmeans.tex}

    \input{./tables/CLUST/desc/clust1std_desc.tex}

    \input{./tables/CLUST/clust2stdkmeans.tex}

    \input{./tables/CLUST/desc/clust2std_desc.tex}

    \input{./tables/CLUST/clust3stdkmeans.tex}

    \input{./tables/CLUST/desc/clust3std_desc.tex}

    \input{./tables/CLUST/clust4stdkmeans.tex}

    \input{./tables/CLUST/desc/clust4std_desc.tex}

    \input{./tables/CLUST/clust5stdkmeans.tex}

    \input{./tables/CLUST/desc/clust5std_desc.tex}

    \input{./tables/CLUST/clust6stdkmeans.tex}

    \input{./tables/CLUST/desc/clust6std_desc.tex}

    \input{./tables/CLUST/clust7stdkmeans.tex}

    \input{./tables/CLUST/desc/clust7std_desc.tex}

    \input{./tables/CLUST/clust8stdkmeans.tex}

    \input{./tables/CLUST/desc/clust8std_desc.tex}

    \input{./tables/CLUST/clust9stdkmeans.tex}
