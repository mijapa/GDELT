...
\begin{document}
    ...
    W części~\ref{ch:przegląd-dziedziny} przeanalizowane zostały prace dotyczące zbioru danych GDELT.
    ...
    W tym rozdziale zostały opisane założenia i wymagania oraz efekt końcowy projektu.
    ...
    W tym rozdziale opisane zostały metody i narzędzia wykorzystane podczas realizacji projektu oraz plan pracy.
    ...
    W pierwszej kolejności przeanalizowane zostaną dane dotyczące Polski, co pozwoli na łatwiejsze wychwycenie związków między zarejestrowanymi wydarzeniami, a sytuacją w kraju.
    ...
    \chapter[Grupowanie państw]{Grupowanie państw o~podobnych cechach oraz~porównanie z danymi zewnętrznymi}
    ...
    W niniejszej części zostaną opisane wnioski z pracy według kolejności wcześniej przedstawionych rozdziałów oraz propozycje dalszych kierunków rozwoju.
