...
\begin{document}
    ...
    \begin{figure}[!htp]
        ...
        \label{fig:GLOBALERC}
    \end{figure}
    Obserwujemy prawie dwukrotną przewagę kodu \textit{CONSULT} nad następnym w kolei kodem \textit{MAKE PUBLIC STATEMENT}.
    ...
    Zauważalne jest częstsze występowanie kodów \textit{MAKE PUBLIC STATEMENT} oraz \textit{DISAPROVE}.
    ...
    Wyraźnie dominuje kod podstawowy \texit{CONSULT}.
