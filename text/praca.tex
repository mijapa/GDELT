...
\begin{document}
    ...
    \input{./tables/CLUST/clust0kmeans.tex}
    \input{./tables/CLUST/clust1kmeans.tex}
    \input{./tables/CLUST/clust2kmeans.tex}
    \input{./tables/CLUST/clust3kmeans.tex}
    \input{./tables/CLUST/clust4kmeans.tex}
    \input{./tables/CLUST/clust5kmeans.tex}
    \input{./tables/CLUST/clust6kmeans.tex}
    \input{./tables/CLUST/clust7kmeans.tex}
    \input{./tables/CLUST/clust8kmeans.tex}
    \input{./tables/CLUST/clust9kmeans.tex}
    ...
    Klaster 0 w tabeli~\ref{tab:cl0std} zawiera 1 kraj.
    Wyróżnia się bardzo wysokim PKB (powyżej 2.42e+12\$) oraz wydatkami na opiekę zdrowotną (powyżej 1.2\% PKB).

    \input{./tables/CLUST/desc/clust0std_desc.tex}
    ...
    Klaster 1 w tabeli~\ref{tab:cl1stdcount} zawiera 18 krajów.
    Wyróżnia się niskim PKB (pomiędzy 5.71e+09\$ i 4.29e+10\$) oraz średnimi wydatkami na opiekę zdrowotną (pomiędzy 4.9, a 7.9\% PKB).

    \input{./tables/CLUST/desc/clust1std_desc.tex}
    ...
    Klaster 2 w tabeli~\ref{tab:cl2stdcount} zawiera 12 krajów.
    Wyróżnia się średnimi wydatkami na opiekę zdrowotną (pomiędzy 4.9, a 7.9\%PKB) oraz niskimi na zbrojenia (pomiędzy 1.6, a 2.8\% PKB).

    \input{./tables/CLUST/desc/clust2std_desc.tex}
    ...
    \begin{figure}[!htp]
        ...
        \label{tab:cl3std}
    \end{figure}
    \input{./tables/CLUST/desc/clust3std_desc.tex}
    ...
    Klaster 3 w tabeli~\ref{tab:cl3stdcount} zwiera 43 kraje.
    Wyróżnia się bardzo niskimi wydatkami na zbrojenia (poniżej 1.6\% PKB).
    ...
    Klaster 4 w tabeli~\ref{tab:cl4stdcount} zawiera 26 krajów.
    Wyróżnia się średnimi wydatkami na opiekę zdrowotną (pomiędzy 4.9, a 7.9\% PKB) oraz bardzo niskimi na zbrojenia (poniżej 1.6\% PKB).

    \input{./tables/CLUST/desc/clust4std_desc.tex}
    \begin{figure}[!htp]
        \centering
    ...
    Klaster 5 w tabeli~\ref{tab:cl5stdcount} zawiera 32 kraje.
    Wyróżnia się średnim PKB (pomiędzy 4.29e+10\$, a 3.23e+11\$) oraz bardzo niskimi wydatkami na zbrojenia (poniżej 1.6\% PKB).

    \input{./tables/CLUST/desc/clust5std_desc.tex}
    ...
    Klaster 6 w tabeli~\ref{tab:cl6stdcount} zawiera 8 krajów.
    Wyróżnia się niskim PKB (pomiędzy 5.71e+09\$, a 4.29e+10\%)oraz dużą ilością brakujących danych dla pozostałych parametrów.

    \input{./tables/CLUST/desc/clust6std_desc.tex}
    ...
    Klaster 7 w tabeli~\ref{tab:cl7stdcount} zawiera 10 krajów.
    Wyróżnia się wysokim i bardzo wysokim PKB (pomiędzy 3.23e+11\$, a 1.82e+13\$)oraz wysokimi wydatkami na zdrowie (pomiędzy 7.9, a 12.7\% PKB).

    \input{./tables/CLUST/desc/clust7std_desc.tex}
    ...
    \input{./tables/CLUST/desc/clust8std_desc.tex}
    ...
    Klaster 9 w tabeli~\ref{tab:cl9stdcount} zawiera 9 krajów.
    Wyróżnia sie niskim PKB (pomiędzy 5.71e+09\$, a 4.29e+10\$), niskimi wydatkami na opiekę zdrowotną (pomiędzy 3, a 4.9\% PKB) oraz zbrojenia (pomiędzy 1.6, a 2.8\% PKB).

    \input{./tables/CLUST/desc/clust9std_desc.tex}
